...
export default function VegItems() {
  ...
  return (
    <main style={{ background: "#080808", color: "#f0f0f0", minHeight: "100vh", padding: "72px 0 96px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        ...
        {/* Page Header */}
        <header style={{ textAlign: "center", marginBottom: 56, maxWidth: 640, margin: "0 auto 56px" }}>
          <span style={{ display: "inline-block", fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase", color: "#22c55e", background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.2)", padding: "6px 18px", borderRadius: 100, marginBottom: 20 }}>
            🌱 Pure Vegetarian
          </span>
          <h1 style={{ fontSize: "clamp(36px, 5vw, 60px)", fontWeight: 900, letterSpacing: -1, lineHeight: 1.1 }}>
            Veg <span style={{ background: "linear-gradient(135deg,#22c55e,#16a34a)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Special</span> Menu
          </h1>
          <p style={{ color: "#777", marginTop: 16, fontSize: 15, lineHeight: 1.7 }}>
            Handpicked fresh vegetarian dishes prepared with local garden ingredients and authentic herbs.
          </p>
        </header>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <select
              ...
              style={{
                ...
                color: "#f0f0f0", padding: "10px 14px", borderRadius: 12,
                ...
                <article key={item.id} className="food-card">
                  ...
                  <div className="food-card-body">
                    ...
                    <p style={{ fontSize: 13, color: "#666", marginTop: 10, lineHeight: 1.7, flex: 1 }}>
                      Authentic recipe made fresh on order with quality green vegetables, pure paneer, and local butter.
                    </p>
